...
public class ConsoleRoundOutputter implements RoundOutputter {
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#showCpuCards(int, int)
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#print(java.lang.String)
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#reward()
     */
	@Override
    public void reward() {
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#roundOver()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#playedCard(int)
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#nextRound()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#chooseCard()
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.output.RoundOutputter#cardUsedUp()
     */
	@Override
