...
public class ConsoleInputter implements Inputter {
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.Inputter#selectAvailableCard(java.util.List)
     */
	@Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.Inputter#selectCard(java.util.List)
     */
    @Override
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.Inputter#pause()
     */
	@Override
    public void pause() {
	...
	/* (non-Javadoc)
     * @see eu.johncasson.gamble.service.Inputter#yesOrNo()
     */
	@Override
